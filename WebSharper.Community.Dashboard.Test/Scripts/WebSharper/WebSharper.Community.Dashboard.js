     ...
     while(e.MoveNext())
      (function()
      {
       ...
       log((function($1)
       {
        return function($2)
        {
         return $1("Try to find outPort:"+Utils.toSafe($2)+" ");
        };
       }(Global.id))(cell1.OutPortKey));
       {
